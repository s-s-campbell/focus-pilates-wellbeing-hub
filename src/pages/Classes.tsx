  ...
  const classes = [
    {
      ...
      pricing: [
        { type: "Drop-In", price: "R180" },
        { type: "5-Class Pack", price: "R850" },
        { type: "10-Class Pack", price: "R1600" }
      ],
    ...
    },
    {
      ...
      pricing: [
        { type: "Drop-In", price: "R250" },
        { type: "5-Class Pack", price: "R1200" },
        { type: "10-Class Pack", price: "R2300" }
      ],
    ...
    },
    {
      ...
      pricing: [
        { type: "Single Private Session", price: "R550" },
        { type: "5-Session Pack", price: "R2600" }
      ],
    ...
    },
    {
      ...
      pricing: [
        { type: "Term-based pricing", price: "Enquire for details" }
      ],
      ...
      <section className="pt-20 pb-16 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            We offer a range of mat and reformer Pilates classes in both group and private settings. 
            All our classes are kept small to ensure you receive personalised feedback and guidance. 
            Unsure where to start? Book an introductory private session so we can assess your needs 
            and recommend the perfect path for you.
          </p>
        </div>
      </section>
