...
const TestimonialSnippet = () => {
  return (
    <section className="mobile-section-spacing bg-secondary/30">
      <div className="max-w-4xl mx-auto mobile-container text-center">
        <h2 className="font-heading mobile-heading-optimize mb-8 sm:mb-12 text-primary">
          Hear From Our <span className="text-primary">Community</span>
        </h2>
        
        <Card className="bg-card/95 backdrop-blur-sm border-0 shadow-xl">
          <CardContent className="mobile-card-spacing sm:p-8 md:p-12 bg-card">
            <Quote className="w-8 h-8 sm:w-12 sm:h-12 text-primary mx-auto mb-4 sm:mb-6 opacity-50" />
            <blockquote className="mobile-text-optimize sm:text-lg md:text-xl text-card-foreground leading-relaxed mb-4 sm:mb-6 italic">
