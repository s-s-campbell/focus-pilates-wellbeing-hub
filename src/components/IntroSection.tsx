    ...
    <section className="responsive-section-spacing bg-background">
      <div className="max-w-6xl mx-auto responsive-container">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="font-heading responsive-heading-optimize mb-4 sm:mb-6 text-primary">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-4 sm:space-y-6 order-2 lg:order-1">
            <p className="responsive-text-optimize text-foreground/80 leading-relaxed">
